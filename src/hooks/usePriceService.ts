      ...
      onMarketInfoUpdate: (rawInfo: Record<MarketSlug, ParsedMarketInfo>) => {
        ...
        for (const [slug, data] of Object.entries(rawInfo)) {
          brandedInfo[slug as MarketSlug] = {
            ...
            poolAmountLong: usd(data.poolAmountLongUsd),
            poolAmountShort: usd(data.poolAmountShortUsd),
            maxOpenInterestLong: usd(data.maxOpenInterestLongUsd),
            maxOpenInterestShort: usd(data.maxOpenInterestShortUsd),
